    ...
    return (
      <nav className="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul className="nav">
          ...
          <li className={this.isPathActive('/u3d') ? 'nav-item menu-items active' : 'nav-item menu-items'}>
            <div className={this.state.u3dMenuOpen ? 'nav-link menu-expanded' : 'nav-link'} onClick={() => this.toggleMenuState('u3dMenuOpen')} data-toggle="collapse">
